        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseSaleDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CourseSaleTotalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CourseSaleState = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesSales", x => x.CourseSaleId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoState = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesSalesDetails", x => x.CourseSaleDetailId);
                    table.ForeignKey(
                        name: "FK_CoursesSalesDetails_CoursesSales_CourseSaleId",
                        column: x => x.CourseSaleId,
                        principalTable: "CoursesSales",
                        principalColumn: "CourseSaleId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoursesSalesDetails_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewState = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CourseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursesSalesDetails_CourseId",
                table: "CoursesSalesDetails",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CoursesSalesDetails_CourseSaleId",
                table: "CoursesSalesDetails",
                column: "CourseSaleId");
